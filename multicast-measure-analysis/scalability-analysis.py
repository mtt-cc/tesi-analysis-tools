...
plt.title("Multicast-based - Ideal Network Conditions")
# plt.legend()
ax = plt.gca()
...
plt.xlabel("Time (s)")
plt.ylabel("Number of Nodes Discovered")
plt.title("Multicast-based - 5% packet loss")
# plt.legend()
ax = plt.gca()
ax.yaxis.set_minor_locator(ticker.MultipleLocator(1))
ax.xaxis.set_minor_locator(ticker.MultipleLocator(0.1))
...
plt.xlabel("Time (s)")
plt.ylabel("Number of Nodes Discovered")
plt.title("Multicast-based - 10% packet loss")
# plt.legend()
ax = plt.gca()
ax.yaxis.set_minor_locator(ticker.MultipleLocator(1))
ax.xaxis.set_minor_locator(ticker.MultipleLocator(0.1))
...
plt.xlabel("Time (s)")
plt.ylabel("Number of Nodes Discovered")
plt.title("Multicast-based - 25% packet loss")
# plt.legend()
ax = plt.gca()
ax.yaxis.set_minor_locator(ticker.MultipleLocator(1))
...
plt.ylim(bottom=1)
plt.xlabel("Time (s)")
plt.yticks([1, 5, 10, 12, 14])
plt.ylabel("Number of Nodes Discovered")
plt.title("DHT-based - Ideal Network Conditions")
plt.legend()
ax = plt.gca()
ax.yaxis.set_minor_locator(ticker.MultipleLocator(1))
...
plt.yticks([1, 5, 10, 12, 14])
plt.ylabel("Number of Nodes Discovered")
plt.title("DHT-based - Ideal Network Conditions 2")
plt.legend()
ax = plt.gca()
ax.yaxis.set_minor_locator(ticker.MultipleLocator(1))
ax.xaxis.set_minor_locator(ticker.MultipleLocator(1))
...
plt.yticks([1, 5, 10, 12, 14])
plt.ylabel("Number of Nodes Discovered")
plt.title("DHT-based - 10% packet loss")
plt.legend()
ax = plt.gca()
ax.yaxis.set_minor_locator(ticker.MultipleLocator(1))
ax.xaxis.set_minor_locator(ticker.MultipleLocator(1))
