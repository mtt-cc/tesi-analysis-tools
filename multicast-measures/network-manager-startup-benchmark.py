...
def benchmark_startup_time():
    """Measure the startup time for the DaemonSet and return the elapsed time."""
...
def run_benchmark(n, output_file):
    ...
    for i in range(n):
        ...
        elapsed_time = benchmark_startup_time()
...
if __name__ == "__main__":
    ...
    output_file = "netmanager_benchmark_results_startup.json"
